...
namespace SOLID_PRINCIPLES.SRP
{
    public class Invoice
    {
        ...
        private ILogger fileLogger; // Delegates from Logger.cs class which contains methods inside the Info, Debug and Error.
       
       /* Delegates from MailSender.cs class which contains properties like, EmailFrom, EmailTo, EmailSubject, and EmailBody.
        Also we have method inside named 'SendEmail()'*/
